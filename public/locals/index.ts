...
export { default as logoutEN } from "./en/logout.json";
export { default as logoutAR } from "./ar/logout.json";
export { default as projectsEN } from "./en/projects.json";
export { default as projectsAR } from "./ar/projects.json";
export { default as teamsAR } from "./ar/teams.json";
export { default as teamsEN } from "./en/teams.json";
